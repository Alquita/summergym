...
export async function getSettings(): Promise<Settings> {
  ...
  cachedSettings = {
    ...
    cuotaMensual: Number(data.cuota_mensual),
...
function getInitialClients(): Omit<Client, 'id'>[] {
  ...
  const list = [
    ...
    { nombre: 'Sandra', apellido: 'Garro', fechaNacimiento: '1968-12-06', edad: 56, direccion: 'Pasaje Cafeto N°2694', telefono: '3584387645', telefonoEmergencia: '3584193429', plan: '2 dias', fechaIngreso: '2025-05-09' },
